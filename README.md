September 2021 Update: rotational overlapping strategies implemented; can be regarded as a computationally improved version of the original overlapping strategies, inspird from close chains.
